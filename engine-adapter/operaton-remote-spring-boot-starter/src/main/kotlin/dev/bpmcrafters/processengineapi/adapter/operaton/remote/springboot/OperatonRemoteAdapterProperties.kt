...
class OperatonRemoteAdapterProperties(
  /**
   * Flag to enable or disable the entire Operaton remote adapter.
   */
  ...
  companion object {
    const val DEFAULT_PREFIX = "dev.bpm-crafters.process-api.adapter.operaton-remote"
  }
