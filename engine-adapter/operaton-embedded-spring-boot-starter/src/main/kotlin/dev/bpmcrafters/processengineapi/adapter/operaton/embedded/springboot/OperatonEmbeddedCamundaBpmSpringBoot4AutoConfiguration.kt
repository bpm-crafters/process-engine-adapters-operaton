...
class OperatonEmbeddedCamundaBpmSpringBoot4AutoConfiguration {

  @PostConstruct
  fun report() {
    logger.debug { "PROCESS-ENGINE-OPERATON-EMBEDDED-204: Spring Boot 4 Camunda compatibility configuration applied." }
  }
