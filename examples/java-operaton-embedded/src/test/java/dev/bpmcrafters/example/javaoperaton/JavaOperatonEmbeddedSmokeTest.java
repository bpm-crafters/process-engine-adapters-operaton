...
/**
 * Starts the actual Spring Boot application context and executes a complete embedded-engine flow.
 *
 * The test is deliberately broader than the unit-level condition tests: it verifies that Operaton's
 * process engine, scheduled adapter delivery, user-task completion, and message correlation all work
 * together on Spring Boot 4.
 */
@SpringBootTest(
  classes = JavaOperatonEmbeddedExampleApplication.class,
...
class JavaOperatonEmbeddedSmokeTest {
